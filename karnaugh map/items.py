...
class Term():
    ...
    @property
    def ones(self):
        """ ||| Contar o número de '1's no termo. ||| """

        """ ||| Return int: Retorna a quantidade de '1's em forma de inteiro. ||| """
...
#Quine McCluskey Method - Encontrar implicantes primos principais.
def find_prime_implicants(minterms, not_cares):
    ...
    while new_implicants:
        ...
        for key in sorted(table.keys()):
            ...
            for term in terms1:
                if not term.flag:
                    print(f"{term} implicante principal")
...
#Petrick's Method - Encontrar implicantes primos essenciais.
